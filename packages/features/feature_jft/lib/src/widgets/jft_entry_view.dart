  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: Space.sm),
        Text(entry.quote.value, textAlign: TextAlign.center, style: quote),
        const SizedBox(height: Space.xs),
        Text(entry.source.value, textAlign: TextAlign.right, style: source),
        const SizedBox(height: Space.lg),
        Text(entry.text.value, style: body),
